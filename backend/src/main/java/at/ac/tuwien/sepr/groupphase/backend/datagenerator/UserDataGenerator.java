...
public class UserDataGenerator {
    ...
    public UserDataGenerator(UserRoleRepository userRoleRepository, RoleRepository roleRepository, UserRepository userRepository) {
    ...
    private void generateMessage() {
        ...
        ApplicationUser au = aub.withemail("admin@email.com").withpassword("password").withid(1).withusername("admin").withhasProfilePicture(false).build();
